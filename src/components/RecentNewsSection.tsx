  ...
  return (
    <section className="relative w-full py-20 bg-white dark:bg-black transition-colors duration-300">
      ...
      <div className="relative z-10 w-full min-h-[400px] flex items-center justify-center">
        {loading ? (
          <div className="text-black dark:text-white opacity-50">Loading...</div>
        ) : blogs.length === 0 ? (
          <div className="text-black dark:text-white opacity-50">No recent news found.</div>
        ) : (
          <div className="w-full flex flex-row gap-6 md:gap-8 overflow-x-auto snap-x snap-mandatory pb-8 hide-scrollbar px-6 md:px-12">
